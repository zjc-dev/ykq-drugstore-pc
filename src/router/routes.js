...
// 导出公共路由
export default [...withdrawRouter, ...accountfundsRouter, ...HomeRouter, ...ResourceRouter, ...ErroRouter, ...baiduRouter1, ...messRouter, ...loginRouter, ...registerRouter, ...storeManListRouter];
